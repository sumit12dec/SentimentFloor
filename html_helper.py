...
class HTMLHelper:
    ...
    def getDefaultHTML(self, error = 0):
        html = '''
<html>
<head><title>A floor full of Sentiments</title>
...
<body>
    ...
    <div class="yui3-u" id="hd">
        <h2>A Floor full of Sentiments - Twitter Sentiment Analyzer </h2>
    </div>
...
'''
    ...
    <div id='ft'>Hacked by:- Sumit Raj <br/></div>
...
'''
    ...
    def getResultHTML(self, keyword, results, time, pos_count, neg_count, neut_count, checked):
        ...
        html = '''
<html>
<head><title>A Floor full of Sentiments - SentimentFloor</title>
    <link rel="stylesheet" type="text/css" href="http://yui.yahooapis.com/3.4.1/build/cssgrids/grids-min.css" />
    <link rel="stylesheet" type="text/css" href="static/styles.css" />
    <link rel="stylesheet" type="text/css" href="static/css/bootstrap/css/bootstrap.css" />
    <link rel="stylesheet" type="text/css" href="static/css/font-awesome-4.3.0/css/font-awesome.css" />
